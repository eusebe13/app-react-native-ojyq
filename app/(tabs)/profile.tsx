...
> = {
    Actif:  { color: "#10B981", bg: "rgba(16,185,129,0.15)",  icon: "check-circle",  label: "Actif"  },
    Pause:  { color: "#F59E0B", bg: "rgba(245,158,11,0.15)",  icon: "pause-circle",  label: "Pause"  },
    Visite: { color: "#06B6D4", bg: "rgba(6,182,212,0.15)",   icon: "eye-circle",    label: "Visite" },
    Arrêt:  { color: "#EF4444", bg: "rgba(239,68,68,0.15)",   icon: "close-circle",  label: "Arrêt"  },
};
...
function NavCard({
    ...
    return (
        <View style={{ marginHorizontal: tokens.space.lg, marginTop: tokens.space.lg }}>
            {title && (
                <Text style={{
...
export default function ProfileScreen() {
    ...
    const preset = profile.avatarPreset !== undefined
    ...
    if (loading) {
        return (
            <View style={{ flex: 1, alignItems: "center", justifyContent: "center", backgroundColor: colors.surfaceDim }}>
            ...
            >
                ...
                <View style={styles.statusCard}>
                    ...
                    <View style={styles.statusRow}>
                        {(Object.entries(STATUS_CONFIG) as [UserStatus, typeof STATUS_CONFIG[UserStatus]][]).map(
                            ([key, cfg]) => {
                ...
                >
                    <Pressable style={[styles.modalSheet, { backgroundColor: colors.surface }]}>
                        ...
                        {profile.avatarPreset !== undefined && profile.avatarPreset !== null && (
                            ...
                            >
                                <Icon name="text-short" size={16} color={colors.textSecondary} />
...
const getStyles = (colors: ReturnType<typeof import("@/theme/tokens").getThemeTokens>["colors"], tokens: ReturnType<typeof import("@/theme/tokens").getThemeTokens>) =>
    StyleSheet.create({
