...
import { 
  FlatList, StyleSheet, Text, TextInput, View, TouchableOpacity, 
            ...
            <View style={[
              ...
              <View style={styles.contentContainer}>
                ...
                <View style={styles.detailsRow}>
                    <Text style={[styles.eventType, { color: item.type === 'Shift' ? '#FF9500' : '#007AFF' }]}>
          ...
          <View style={styles.modalView}>
            ...
            <ScrollView style={{width: '100%'}}>
                ...
                <View style={styles.typeSelector}>
                    <TouchableOpacity 
                        style={[styles.typeButton, !isShiftMode && styles.typeButtonActive]}
                        onPress={() => setIsShiftMode(false)}
                    >
                        <Text style={[styles.typeText, !isShiftMode && styles.typeTextActive]}>Général</Text>
                    </TouchableOpacity>
                    <TouchableOpacity 
                        style={[styles.typeButton, isShiftMode && styles.typeButtonActiveShift]}
                        onPress={() => setIsShiftMode(true)}
                    >
                        <Text style={[styles.typeText, isShiftMode && styles.typeTextActive]}>Quart de travail</Text>
                    </TouchableOpacity>
                </View>
            ...
            <View style={styles.modalButtons}>
                ...
                <TouchableOpacity onPress={handleAddEvent} style={styles.buttonSave}>
...
const styles = StyleSheet.create({
  ...
  // Styles de la Carte
  eventCard: { flexDirection: 'row', backgroundColor: "#fff", padding: 15, borderRadius: 12, marginBottom: 12, shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 4, elevation: 2, borderLeftWidth: 5 },
  dateContainer: { marginRight: 15, alignItems: 'center', justifyContent: 'center', borderRightWidth: 1, borderRightColor: '#eee', paddingRight: 15, minWidth: 60 },
  ...
  eventType: { fontSize: 10, fontWeight: 'bold', textTransform: 'uppercase', marginRight: 10 },
  ...
  // Bouton Flottant (FAB)
  fab: { position: 'absolute', right: 20, bottom: 30, width: 56, height: 56, borderRadius: 28, backgroundColor: '#007AFF', justifyContent: 'center', alignItems: 'center', elevation: 8, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 3.84 },
  ...
  label: { alignSelf: 'flex-start', color: '#666', marginBottom: 5, fontSize: 12, fontWeight: '600' },
  input: { width: '100%', height: 45, borderColor: '#ddd', borderWidth: 1, borderRadius: 8, paddingHorizontal: 10, marginBottom: 15, backgroundColor: '#f9f9f9' },
  row: { flexDirection: 'row', width: '100%', justifyContent: 'space-between' },
  
  // Selecteur de Type
  typeSelector: { flexDirection: 'row', width: '100%', marginBottom: 20, backgroundColor: '#f0f0f0', borderRadius: 8, padding: 4 },
  typeButton: { flex: 1, paddingVertical: 8, alignItems: 'center', borderRadius: 6 },
  typeButtonActive: { backgroundColor: '#fff', shadowColor: "#000", shadowOpacity: 0.1, shadowRadius: 2, elevation: 1 },
  typeButtonActiveShift: { backgroundColor: '#fff', shadowColor: "#000", shadowOpacity: 0.1, shadowRadius: 2, elevation: 1 },
  ...
  buttonSave: { flex: 1, backgroundColor: '#007AFF', borderRadius: 8, padding: 12, alignItems: 'center' },
